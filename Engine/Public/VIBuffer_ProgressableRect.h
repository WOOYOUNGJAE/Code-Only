...
class ENGINE_DLL CVIBuffer_ProgressableRect final : public CVIBuffer_Rect
{
protected:
	CVIBuffer_ProgressableRect(LPDIRECT3DDEVICE9 pGraphic_Device);
	CVIBuffer_ProgressableRect(const CVIBuffer_ProgressableRect& rhs);
	virtual ~CVIBuffer_ProgressableRect() = default;
...
public:
	static CVIBuffer_ProgressableRect* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
