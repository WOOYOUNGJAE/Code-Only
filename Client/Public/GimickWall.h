...
class CGimickWall final : public CGameObject
{
protected:
	CGimickWall(LPDIRECT3DDEVICE9 pGraphic_Device);
	CGimickWall(const CGimickWall& rhs);
	virtual ~CGimickWall() = default;
...
public:
	static CGimickWall* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
